       ...
       <div className="field">
           ...
           <input
               ...
               onChange={ e => props.setTitulo(e.target.value) }
                placeholder={props.producto.titulo}
           />
       </div>
       ...
       <label htmlFor="address">Dirección</label>
           <input
               ...
               onChange={ e => props.setDireccion(e.target.value) }
                placeholder={props.producto.direccion}
   ...
   <div className="create-product-form-row">
       <div className="field">
           ...
           <input
              ...
              placeholder={props.producto.latitud}
           />
       </div>
       ...
       <label htmlFor="long">Longitud</label>
           <input
              ...
              placeholder= {props.producto.longitud}
           />
...
<div className='select-box-propiedad'>
   ...
   <div className="field description">
       ...
       onChange={ e => props.setDescripcion(e.target.value) }
        placeholder={props.producto.descripcion}
...
export default UpdatePropiedad